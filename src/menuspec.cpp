...
static MenuSpec menu_specs[] = {
  ...
  {TW::ID_TOLOWER,          "EditLower",       _("Lo&wer Case"),        _("lower"),        "Shift+Ctrl+^", 'm', {NULL}},
  ...
  {TW::ID_INDENT_FULL,      "EditTabIn",       _("&Indent right  "),    _("shift right"),  "Shift+Ctrl+)", 'm', {NULL}},
  {TW::ID_UNINDENT_FULL,    "EditUntab",       _("In&dent left   "),    _("shift left"),   "Shift+Ctrl+(", 'm', {NULL}},
  ...
  {TW::ID_ZOOM_NEAR,        "ViewZoomNear",    _("&Closest "),          _("zoom near"),    "Shift+Ctrl++", 'm', {NULL}},
  {TW::ID_ZOOM_FAR,         "ViewZoomFar",     _("&Furthest "),         _("zoom far"),     "Shift+Ctrl+_", 'm', {NULL}},
